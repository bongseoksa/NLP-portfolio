...
| 단계 | 기간 | 주요 목표 | 상태 |
|------|------|----------|------|
| **Phase 1: MVP** | Week 1-2 | 기본 Q&A 기능 구현 | ✅ 완료 |
| **Phase 2: Multi-Repo** | Week 3 | 다중 레포 지원 | ✅ 완료 |
| **Phase 3: CI Automation** | Week 4 | GitHub Actions 파이프라인 | ✅ 완료 |
| **Phase 4: Optimization** | Week 5-6 | 성능 최적화, LLM Fallback | 🔄 진행 중 |
| **Phase 5: Migration** | Week 7-8 | Hugging Face 임베딩 전환 | 📋 예정 |
...
- [API 명세서](./05_api/01_API_Specification.md)
