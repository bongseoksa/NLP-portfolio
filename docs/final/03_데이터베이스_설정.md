...
> **문서 버전**: v1.0
> **작성일**: 2026-01-05
> **이전 문서**: [02_시스템_아키텍처.md](./02_시스템_아키텍처.md)
> **다음 문서**: [04_임베딩_파이프라인_구축.md](./04_임베딩_파이프라인_구축.md)
> **예상 시간**: 30분
...
👉 **[04_임베딩_파이프라인_구축.md](./04_임베딩_파이프라인_구축.md)** - GitHub 데이터 수집 및 임베딩 생성

---

## 9. 관련 문서

- [데이터베이스 스키마 상세](../../CLAUDE.md#schema)
